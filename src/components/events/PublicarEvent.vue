                ...
                <vs-card vs-color="primary">
                  ...
                  <vs-card-body>
                    ...
                    <vs-row vs-align="flex-start">
                      <vs-col vs-type="block" vs-justify="left" vs-align="left" vs-lg="12" vs-sm="12" >
                         <div class="creditCardForm" id="login-block">
                            <vs-input
                                id="creditCardName" 
                                :vs-valid.sync="creditCardValid.fullName"
                                vs-success-text="Nombre valido"
                                vs-danger-text="Nombre invalido"
                                :vs-validation-function="(e)=>e.length > 4"
                                vs-type="custom"
                                vs-label="Nombre completo"
                                v-model="creditCard.fullName"/>

                            <div class="item" style="padding: 0px 10px;">
                              <label for="idType" id="lblIdType" style="font-size:12px; color:black;margin-top:0px">
                                  Tipo documento
                              </label>
                              <vs-select
                                  id="idType"
                                  :vs-valid.sync= "validos.idType"
                                  v-on:change="validateSelect"
                                  class="vs-w-12 left"
                                  v-model="eventos.country"
                                  :options="creditCard.idOptions"/>
                             </div>

                            <vs-input
                                id="idNnumber"  
                                :vs-valid.sync = "creditCardValid.idNumber"
                                vs-success-text="Documento valido"
                                vs-danger-text="Documento invalido"
                                :vs-validation-function="(e)=>e.length > 9"
                                vs-type="number" 
                                vs-label="Documento"
                                v-model="creditCard.idNumber"/>

                            <vs-input
                                id="creditCardNumber"  
                                :vs-valid.sync = "creditCardValid.creditCardNumber"
                                vs-success-text="Tarjeta de credito Aceptada"
                                vs-danger-text="Tarjeta de credito rechazada"
                                :vs-validation-function="(e)=>e.length > 16"
                                vs-type="custom" 
                                vs-label="Número tarjeta de credito"
                                v-model="creditCard.creditCardNumber"/>

                            <vs-input
                                id="securityCode"  
                                :vs-valid.sync= "creditCardValid.securityCode"
                                vs-success-text="Correo Valido"
                                vs-danger-text="Verifique email"
                                :vs-validation-function="(e)=>e.length == 3"
                                vs-type="custom" 
                                vs-label="codigo de seguridad"
                            ...
                            <div class="details-item" id="date">
                                <div class="item">
                                  <el-date-picker
                                    :vs-valid.sync= "creditCardValid.expirationDate"
                            ...
                            <vs-input 
                                ...
                                vs-type="custom" 
                                disabled="true"
                                vs-label="Valor a pagar"
                                v-model="eventos.cost"/>
                      ...
                      <vs-col vs-type="block" vs-justify="left" vs-align="left" vs-lg="12" vs-sm="12" >
                        ...
                        <svg width="10%" viewBox="0 0 212 40">
                          <!-- Payment -->
                            <defs>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      clicked (e) {
        this.markers.latLeng = e.latLng
        this.alertMap("Confirmar", "¿Desea confirmar el lugar del evento?")
      },
      saveCoordinates : function(){
        this.eventos.latitude = this.markers.latLeng.lat()
        this.eventos.longitude = this.markers.latLeng.lng()
      },
